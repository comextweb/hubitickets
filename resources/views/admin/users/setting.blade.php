            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-xl-4 col-md-4">
                                                    <div class="form-group">
                                                        <label for="app_name"
                                                            class="form-label">{{ __('App Name') }}</label>
                                                ...
                                                <div class="col-lg-4 col-xl-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="footer_text" id="footer_text"
                                                            class="form-control" placeholder="{{ __('Footer Text') }}"
                                                        ...
                                                        <div class="changeLanguage">
                                                            <select name="default_language" id="default_language"
                                                                ...
                                                                @foreach (languages() as $code => $language)
                                                                    <option
                                                                        @if ($defaultSelectedLang == $code) selected @endif
                                                                        value="{{ $code }}">
                                                    ...
                                                    <div class="row d-flex align-items-center justify-content-center">
                                                        <div class="col-6">
                                                            <div class="form-group col-md-12 mt-2">
                                                                <label for="timezone"
                                                                    class="form-label">{{ __('Timezone') }}</label>
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail Driver') }}</label><x-required></x-required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail Host') }}</label><x-required></x-required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail Port') }}</label><x-required></x-required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail Username') }}</label><x-required></x-required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail Password') }}</label><x-required></x-required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail Encryption') }}</label><x-required></x-required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail From Address') }}</label><x-required></x-required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">{{ __('Mail From Name') }}</label><x-required></x-required>
                                            ...
                                            @if (Laratrust::hasPermission($e_module . ' manage') ||
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link text-capitalize rounded-1 {{ $active }}"
                                                        id="pills-{{ strtolower($e_module) }}-tab-email"
                                                        data-bs-toggle="pill"
                                                            ...
                                                            <div class="col-lg-4 col-sm-6 col-12 mb-3">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="form-check form-switch d-inline-block text-end">
                                                                            <input type="hidden"
                    ...
                    <div id="storage-settings" class="card mb-3">
                        <form action="{{ route('storage.setting.store') }}" method="post"
                                        ...
                                        <div class="form-group col-8 switch-width">
                                            ...
                                            <select name="local_storage_validation[]" class="form-control"
                                                ...
                                                @foreach ($file_type as $f)
                                                    <option
                                                        {{ in_array($f, $local_storage_validations) ? 'selected' : '' }}>
                                                        {{ $f }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-8 switch-width">
                                                ...
                                                <select class="form-control" name="s3_storage_validation[]"
                                                    ...
                                                    @foreach ($file_type as $f)
                                                        <option
                                                            {{ in_array($f, $s3_storage_validations) ? 'selected' : '' }}>
                                                            {{ $f }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class=" row ">
                                            ...
                                            <div class="form-group col-8 switch-width">
                                                ...
                                                <select name="wasabi_storage_validation[]" class="form-control"
                                                    ...
                                                    @foreach ($file_type as $f)
                                                        <option
                                                            {{ in_array($f, $wasabi_storage_validations) ? 'selected' : '' }}>
                                                            {{ $f }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                        ...
                        <form action="{{ route('seo.settings') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div
                                ...
                                @if (isset($setting['is_enabled']) && $setting['is_enabled'] == 'on')
                                    <a class="btn btn-primary btn-sm float-end ms-2 p-2" href="#" data-size="lg"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" id="meta_description" class="form-control" rows="5"
                                                placeholder="Enter Meta Description" required>{{ isset($setting['meta_description']) ? $setting['meta_description'] : '' }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="meta_image"
                                                class="col-form-label">{{ __('Meta Image') }}</label>
                                            <div>
                                                <a href="{{ isset($setting['meta_image']) && checkFile($setting['meta_image']) ? getFile($setting['meta_image']) : getFile('uploads/metaevent/meta.png') . '?' . time() }}"
                                                    ...
                                                    <img src="{{ isset($setting['meta_image']) && checkFile($setting['meta_image']) ? getFile($setting['meta_image']) : getFile('uploads/metaevent/meta.png') . '?' . time() }}"
                                                        id="meta_image_pre" class="img_setting" width="400px"
                                                        style="height: 217px;" />
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div id="cookie-settings" class="card mb-3">
                        <form action="{{ route('cookie.setting') }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
                            <div
                                class="card-header flex-column flex-lg-row d-flex align-items-lg-center gap-2 justify-content-between">
                            ...
                            <div
                                ...
                                <div class="row">
                                    @if (isset($setting['is_enabled']) && $setting['is_enabled'] == 'on')
                                        <div class="float-end">
                                            <a class="btn btn-primary btn-sm float-end p-2" href="#" data-size="lg"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="cookie_description" id="cookie_description" class="form-control cookie_setting" rows="3"
                                                required>{{ old('cookie_description', isset($setting['cookie_description']) ? $setting['cookie_description'] : '') }}</textarea>
                                            <small
                                                class="text-danger">{{ __('Please avoid to use enter key for new line. You can use &lt;br&gt; for new Line') }}</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="strictly_cookie_description" id="strictly_cookie_description" class="form-control cookie_setting"
                                                rows="3" required>{{ old('strictly_cookie_description', isset($setting['strictly_cookie_description']) ? $setting['strictly_cookie_description'] : '') }}</textarea>
                                            <small
                                                class="text-danger">{{ __('Please avoid to use enter key for new line. You can use &lt;br&gt; for new Line') }}</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="form-check custom-control custom-switch">
                                            <input type="checkbox" class="form-check-input form-control"
                                                name="is_enabled" data-toggle="switchbutton" data-onstyle="primary"
                                                id="is_enabled"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="chatgpt_key"
                                                class="col-form-label">{{ __('Chat GPT Key') }}</label>
                        ...
                        <form method="POST" action="{{ route('admin.pusher.settings.store') }}" accept-charset="UTF-8"
                            ...
                            <div
                                ...
                                <div class="col-6">
                                    ...
                                    <small
                                        class="text-danger">{{ __('Pusher settings provide real-time updates for ticket creation, replies, and live chat interactions') }}</small>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
