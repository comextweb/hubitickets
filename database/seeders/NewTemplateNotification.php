    ...
    public function run()
    {
        ...
        $defaultTemplate = [
            ...
            'New External Ticket' => [
                ...
                'lang' => [
                    'en' => '<p>Hello,</p>
                            <p>A new ticket has been created from the external form. Here are the details:</p>
                            <p><b>🔹 Ticket Number</b>: {ticket_id}</p>
                            <p><b>🔹 Ticket Subject</b>: {ticket_subject}</p>
                            <p><b>🔹 Priority</b>: {ticket_priority}</p>
                            <p><b>🔹 Category</b>: {ticket_category}</p>
                            <p><b>🔹 Affected Process</b>: {ticket_department}</p>
                            <p><b>🧑‍💼 Requester</b>:</p>
                            <p><b>Name</b>: {customer_name}</p>
                            <p><b>Email</b>: {customer_email}</p>
                            <p><b>📝 Ticket Description</b>:</p>
                            <div>{ticket_description}</div><br>
                            <p>Please log in to the system to review and follow up on this ticket.</p>
                            <p><b>Application URL</b>: {app_url}</p>
                            <p><i>This email was automatically generated by {app_name}. No reply is necessary.</i></p>', 
                    'es' => '<p>Hola,</p>
                            <p>Se ha creado un nuevo ticket desde el formulario externo, aquí están los detalles:</p>
                            <p><b>🔹 Número de ticket</b>: {ticket_id}</p>
                            <p><b>🔹 Asunto del ticket</b>: {ticket_subject}</p>
                            <p><b>🔹 Prioridad</b>: {ticket_priority}</p>
                            <p><b>🔹 Categoría</b>: {ticket_category}</p>
                            ...
                            <p><b>📝 Descripción del ticket</b>:</p>
                            <div>{ticket_description}</div><br>
                            <p>Por favor, ingrese al sistema para revisar y dar seguimiento al ticket.</p>
                            <p><b>URL de la Aplicación</b>: {app_url}</p>
                            <p><i>Este correo fue generado automáticamente por {app_name}. No es necesario responder a este mensaje.</i></p>',
